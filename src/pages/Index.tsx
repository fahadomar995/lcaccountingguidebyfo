...
export default function Index() {
  ...
  return (
    <div className="max-w-[900px] mx-auto px-4 sm:px-7 py-8 pb-16">
        ...
        <Card className="border-l-4 border-l-blue bg-blue-bg hover:bg-blue-bg/70 transition-colors">
          <CardContent className="p-4 sm:p-5 flex items-center gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-xs text-muted-foreground font-light mt-0.5">Mock papers available, split by topic — pure questions practice for Higher Level Maths.</div>
            </div>
      ...
      <div className="space-y-3 mb-8">
        {[
          { version: "v2.7.2", date: "17 Apr 2026", items: ["Q1 Workings (37) and S2 Workings (37) fully regenerated from the canonical original site data — every figure, T-account row, destination tag and N-working now matches the verified marking-scheme source", "35 of 74 walkthroughs had numeric mismatches (figures pulled from intermediate calculations rather than the marking scheme); all 74 are now byte-for-byte aligned with the source", "S2 categories restored to the full 14 Suspense / 8 Club / 5 Service / 5 Published / 5 Cash Flow split", "Trap warnings (red 'THE TRAP' callouts) now render at the bottom of the final step where applicable"] },
