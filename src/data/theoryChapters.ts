        ...
        subTopics: [
          {
            ...
            body: [
              { type: 'concept', variant: 'blue', title: 'Farm Account Structure', html: '<p>1. Similar to a sole trader P&L but with farm-specific terminology.</p><p>2. <strong>Farm produce used in house</strong> = drawings at market value.</p><p>3. <strong>Enterprise analysis</strong> splits income and expenses by farm activity (e.g. dairy, tillage, beef).</p><p>4. Stock includes livestock, crops, fodder, seeds, and fertiliser.</p>' },
              { type: 'table', html: '<table class="learn-table"><thead><tr><th>Farm Term</th><th>Equivalent</th></tr></thead><tbody><tr><td>Farm produce used in house</td><td>Drawings (at market value)</td></tr><tr><td>Closing valuation of livestock</td><td>Closing stock</td></tr><tr><td>Opening valuation of livestock</td><td>Opening stock</td></tr><tr><td>REPS payments / EU subsidies</td><td>Other income</td></tr></tbody></table>' },
            ]
          },
        ]
      },
        ...
        subTopics: [
          {
            ...
            body: [
              { type: 'concept', variant: 'blue', title: 'When Do They Arise?', html: '<p>1. Small businesses that only keep a cash book and bank statements.</p><p>2. Records destroyed by fire, flood, or theft.</p><p>3. Single-entry systems (only some transactions recorded).</p><p>Two methods are used to reconstruct the accounts: <strong>Control Account / Cash Method</strong> and <strong>Net Worth / Balance Sheet Method</strong>.</p>' },
            ]
          },
        ]
      },
