...
export const LAYOUT_TEMPLATES: LayoutTemplate[] = [
  // ═══ 1. ST P&L ═══
  {
    ...
    tables: [{
      ...
      rows: [
        { label: 'Sales', c2: 'XXX', nc: 'N1' },
        { label: 'Less Cost of Goods Sold:', cls: 'b' },
        { label: 'Opening stock', c1: 'XXX', cls: 'i' },
        { label: 'Purchases (adjusted)', c1: 'XXX', cls: 'i', nc: 'N3' },
        { label: 'Less Closing stock', c1: '(XXX)', c2: '(XXX)', cls: 'i', nc: 'N2' },
        { label: 'Gross Profit', c2: 'XXX', cls: 'bs' },
        { label: '', cls: 'bl' },
        { label: 'Less Expenses:', cls: 'b' },
        { label: 'Selling & Distribution', cls: 'b' },
        { label: 'Depreciation — Delivery Vans', c1: 'XXX', cls: 'i', nc: 'N5' },
        { label: 'Loss on disposal of van', c1: 'XXX', cls: 'i', nc: 'N4' },
        { label: 'Advertising', c1: 'XXX', cls: 'i', nc: 'N6' },
        { label: 'Bad debts written off', c1: 'XXX', cls: 'i' },
        { label: 'Increase in prov. for bad debts', c1: 'XXX', cls: 'i', nc: 'N12' },
        { label: 'Carriage outwards', c1: 'XXX', cls: 'i' },
        { label: 'Discount allowed', c1: 'XXX', c2: 'XXX', cls: 'i' },
        { label: '', cls: 'bl' },
        { label: 'Administration', cls: 'b' },
        { label: 'Depreciation — Buildings', c1: 'XXX', cls: 'i', nc: 'N7' },
        { label: 'Insurance', c1: 'XXX', cls: 'i', nc: 'N9' },
        { label: 'Rent payable', c1: 'XXX', cls: 'i' },
        { label: 'Light & Heat', c1: 'XXX', cls: 'i' },
        { label: 'General expenses', c1: 'XXX', cls: 'i' },
        { label: 'Patent written off', c1: 'XXX', cls: 'i', nc: 'N8' },
        { label: '[Other admin expenses]', c1: 'XXX', c2: '(XXX)', cls: 'i' },
        { label: '', cls: 'bl' },
        { label: 'Mortgage / Debenture interest', c2: '(XXX)', cls: 'b', nc: 'N15' },
        { label: '', cls: 'bl' },
        { label: 'Add Income:', cls: 'b' },
        { label: 'Discount received', c1: 'XXX', cls: 'i' },
        { label: 'Rent received', c1: 'XXX', cls: 'i' },
        { label: 'Bad debt recovered', c1: 'XXX', cls: 'i', nc: 'N10' },
        { label: 'Investment income', c1: 'XXX', cls: 'i', nc: 'N14' },
    ...
    tables: [
      {
        ...
        rows: [
          ...
          { label: 'Cost of Sales', c2: '(XXX)', nc: '(A)' },
          { label: 'Gross Profit', c2: 'XXX', cls: 'bs' },
          { label: 'Distribution Costs', c2: '(XXX)', nc: '(B)' },
          { label: 'Administration Expenses', c2: '(XXX)', nc: '(C)' },
          { label: 'Other Operating Income', c2: 'XXX', nc: '(D)' },
          { label: 'Operating Profit', c1: '(1)', c2: 'XXX', cls: 'bs' },
          ...
          { label: 'Dividends Paid', c1: '(2)', c2: '(XXX)' },
          { label: 'Dividends Proposed', c1: '(2)', c2: '(XXX)' },
      ...
      },
      {
        ...
        rows: [
          ...
          { label: 'Tangible Fixed Assets', c1: '(3)', c3: 'XXX', cls: 'i' },
          { label: 'Financial Assets', c1: '(4)', c3: 'XXX', cls: 'i' },
          { label: '', c3: 'XXX', cls: 's' },
          { label: 'Current Assets', cls: 'h' },
          { label: 'Closing stock', c1: 'XXX', cls: 'i' },
