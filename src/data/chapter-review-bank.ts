...
export const REVIEW_BANK: Record<number, ReviewItem[]> = {
  ...
  13: [
    ...
    {
      id: 'r13-14', chapterId: 13, sectionId: '13.1', type: 'sort',
      prompt: 'Sort each item: appears in the Receipts & Payments Account, the Income & Expenditure Account, or BOTH?',
      itemData: { type: 'sort', data: { buckets: ['R&P only', 'I&E only', 'Both'], items: [
        { label: 'Opening bank balance', correctBucket: 'R&P only' },
        { label: 'Purchase of new equipment (capital item)', correctBucket: 'R&P only' },
        { label: 'Depreciation for the year', correctBucket: 'I&E only' },
        { label: 'Subscription arrears written off', correctBucket: 'I&E only' },
        { label: 'Light & heat paid in cash', correctBucket: 'Both' },
        { label: 'Bar wages paid', correctBucket: 'Both' },
      ] } },
      explanation: 'Capital items and bank balances appear only in the R&P. Non-cash items like depreciation appear only in the I&E. Cash expenses appear in both (cash figure in R&P, accruals-adjusted figure in I&E).',
      sectionLink: '13.1.3',
    },
    {
      id: 'r13-15', chapterId: 13, sectionId: '13.1', type: 'mcq',
      prompt: 'A club\'s R&P shows life membership received €8,000. The policy is to spread life membership over 10 years. What is the I&E income figure for life membership?',
      itemData: { type: 'mcq', data: { options: ['€8,000', '€800', '€80', '€7,200'], correctIndex: 1 } },
      explanation: 'Spread €8,000 over 10 years → €800 to I&E. The remaining €7,200 sits as deferred income (liability) on the Balance Sheet.',
      sectionLink: '13.1.3',
    },
    {
      id: 'r13-16', chapterId: 13, sectionId: '13.1', type: 'true-false',
      prompt: 'True or false?',
      itemData: { type: 'true-false', data: {
        statement: 'The closing bank balance from the R&P Account appears as a current asset on the closing Balance Sheet.',
        isTrue: true,
      } },
      explanation: 'The R&P closes with the year-end bank figure — that is the figure carried into current assets on the Balance Sheet.',
      sectionLink: '13.1.3',
    },
  ],
  ...
  19: [
    ...
    {
      id: 'r19-08', chapterId: 19, sectionId: '19.1', type: 'sort',
      prompt: 'Premises (NBV €200,000) revalued to €280,000. Sort the effects.',
      itemData: { type: 'sort', data: { buckets: ['+ €80,000', 'No effect'], items: [
        { label: 'Fixed Assets', correctBucket: '+ €80,000' },
        { label: 'Capital (Revaluation Reserve)', correctBucket: '+ €80,000' },
        { label: 'Current Assets', correctBucket: 'No effect' },
        { label: 'Current Liabilities', correctBucket: 'No effect' },
        { label: 'Long-term Liabilities', correctBucket: 'No effect' },
        { label: 'Profit for the year', correctBucket: 'No effect' },
      ] } },
      explanation: 'A revaluation surplus increases Fixed Assets and Capital (via the Revaluation Reserve) by the same amount. It does NOT pass through profit.',
      sectionLink: '19.1.2',
    },
    {
      id: 'r19-09', chapterId: 19, sectionId: '19.1', type: 'mcq',
      prompt: 'A bonus issue of 1-for-4 on 200,000 €1 ordinary shares from Share Premium. What is the effect on TOTAL Capital?',
      itemData: { type: 'mcq', data: { options: ['+ €50,000', '− €50,000', 'No effect', '+ €200,000'], correctIndex: 2 } },
      explanation: 'Share Capital + €50,000 and Share Premium − €50,000 cancel out — no change in total Capital, no cash movement.',
      sectionLink: '19.1.2',
    },
    {
      id: 'r19-10', chapterId: 19, sectionId: '19.1', type: 'fill-chip',
      prompt: 'Complete the rule.',
      itemData: { type: 'fill-chip', data: { sentence: 'When the SEC asks for the "effect on" cells that have no movement, you should write ___ rather than leaving them blank.', chips: ['"No effect"', '"0"', 'Nothing', 'A question mark'], correctChip: '"No effect"' } },
      explanation: 'Marks are awarded per cell. Writing "No effect" shows the marker you considered the cell — blanks lose the mark.',
      sectionLink: '19.1.2',
    },
  ],
  ...
  20: [
    {
      ...
      prompt: 'Sort each feature: Financial Accounting or Management Accounting?',
      itemData: { type: 'sort', data: { buckets: ['Financial Accounting', 'Management Accounting'], items: [
        { label: 'Past-focused (historical)', correctBucket: 'Financial Accounting' },
        { label: 'Future-focused (forecasts, budgets)', correctBucket: 'Management Accounting' },
        { label: 'For external users (banks, Revenue, shareholders)', correctBucket: 'Financial Accounting' },
        { label: 'For internal managers', correctBucket: 'Management Accounting' },
        { label: 'Must follow FRS 102 / Companies Act format', correctBucket: 'Financial Accounting' },
        { label: 'No prescribed format — designed to suit the user', correctBucket: 'Management Accounting' },
      ] } },
      explanation: 'Financial accounting reports the past to outsiders in a regulated format. Management accounting helps insiders plan and decide for the future, with no statutory format.',
      sectionLink: '20.1.1',
    },
    {
      id: 'r20-02', chapterId: 20, sectionId: '20.1', type: 'mcq',
      prompt: 'Which of these is NOT a primary function of management accounting?',
      itemData: { type: 'mcq', data: { options: ['Planning', 'Control', 'Decision-making', 'Filing tax returns'], correctIndex: 3 } },
      explanation: 'The three roles of management accounting are planning, control and decision-making. Filing tax returns is a financial accounting / compliance task.',
      sectionLink: '20.1.1',
    },
    {
      id: 'r20-03', chapterId: 20, sectionId: '20.1', type: 'fill-chip',
      prompt: 'Complete the sentence about the planning role.',
      itemData: { type: 'fill-chip', data: { sentence: 'In the planning role of management accounting, the main tool used to set targets is the ___.', chips: ['Budget', 'Trial Balance', 'Balance Sheet', 'Trading Account'], correctChip: 'Budget' } },
      explanation: 'Budgets translate plans into financial targets. Variance analysis then feeds the control role.',
      sectionLink: '20.1.1',
    },
    {
      id: 'r20-04', chapterId: 20, sectionId: '20.1', type: 'match',
      prompt: 'Match each management-accounting role with its description.',
      itemData: { type: 'match', data: { pairs: [
        { term: 'Planning', definition: 'Setting future objectives and how to achieve them' },
        { term: 'Control', definition: 'Comparing actual results to budget and acting on differences' },
        { term: 'Decision-making', definition: 'Choosing between alternatives (make-or-buy, special order)' },
        { term: 'Performance evaluation', definition: 'Judging how well managers/departments achieved targets' },
      ] } },
      explanation: 'These four roles run continuously: managers plan, control by comparing to plan, make decisions on alternatives, and evaluate results to feed the next plan.',
      sectionLink: '20.1.1',
    },
    {
      id: 'r20-05', chapterId: 20, sectionId: '20.1', type: 'true-false',
      prompt: 'True or false?',
      itemData: { type: 'true-false', data: {
        statement: 'Management accounting reports must follow the format laid out in FRS 102.',
        isTrue: false,
        followUp: { prompt: 'Why not?', chips: ['They are for internal use, so format is flexible', 'Because they are illegal otherwise', 'Because FRS 102 only covers banks'], correctChip: 'They are for internal use, so format is flexible' },
      } },
      explanation: 'FRS 102 governs published financial accounts for external users. Management accounts are internal — managers design them to suit their decisions.',
      sectionLink: '20.1.1',
    },
    {
      id: 'r20-06', chapterId: 20, sectionId: '20.1', type: 'sort',
      prompt: 'Sort each piece of information: useful for managers (good) or NOT useful (poor)?',
      itemData: { type: 'sort', data: { buckets: ['Useful (good quality)', 'Not useful (poor quality)'], items: [
        { label: 'Timely — produced soon after the event', correctBucket: 'Useful (good quality)' },
        { label: 'Relevant to the decision being made', correctBucket: 'Useful (good quality)' },
        { label: 'Reliable and free from material error', correctBucket: 'Useful (good quality)' },
        { label: 'Comparable across periods or departments', correctBucket: 'Useful (good quality)' },
        { label: 'Out-of-date by the time it reaches the manager', correctBucket: 'Not useful (poor quality)' },
        { label: 'Filled with detail not relevant to the decision', correctBucket: 'Not useful (poor quality)' },
      ] } },
      explanation: 'Good management information is timely, relevant, reliable, comparable and understandable. Without these qualities, the report cannot support a sound decision.',
      sectionLink: '20.1.1',
    },
    {
      id: 'r20-07', chapterId: 20, sectionId: '20.1', type: 'mcq',
      prompt: 'Which user group is the PRIMARY audience for management accounting reports?',
      itemData: { type: 'mcq', data: { options: ['Shareholders', 'Internal managers', 'Revenue Commissioners', 'Trade creditors'], correctIndex: 1 } },
      explanation: 'Management accounts are produced for internal decision-makers. External groups receive the published financial accounts.',
      sectionLink: '20.1.1',
    },
    {
      id: 'r20-08', chapterId: 20, sectionId: '20.1', type: 'define',
      prompt: 'Define the following.',
      itemData: { type: 'define', data: { term: 'Management Accounting', modelDefinition: 'The branch of accounting that provides financial and non-financial information to internal managers to help them plan, control operations and make decisions.' } },
      explanation: 'Management accounting differs from financial accounting in audience (internal vs external), focus (future vs past) and format (flexible vs regulated).',
      sectionLink: '20.1.1',
    },
    {
      id: 'r20-09', chapterId: 20, sectionId: '20.1', type: 'true-false',
      prompt: 'Management accounting reports are produced only once a year.',
      itemData: { type: 'true-false', data: { statement: 'Management accounting reports are produced only once a year.', isTrue: false, followUp: { prompt: 'How often are they produced?', chips: ['As often as managers need them (daily, weekly, monthly)', 'Once every five years', 'Only when the auditor asks for them'], correctChip: 'As often as managers need them (daily, weekly, monthly)' } } },
      explanation: 'Frequency depends on management need. Cash flow may be reported daily, sales weekly, full management accounts monthly.',
      sectionLink: '20.1.1',
    },
    {
      id: 'r20-10', chapterId: 20, sectionId: '20.1', type: 'order',
      prompt: 'Put the management-accounting cycle steps in order.',
      itemData: { type: 'order', data: { steps: [
        'Set objectives and prepare a plan (budget)',
        'Communicate the plan to managers',
        'Record actual results',
        'Compare actual to plan and identify variances',
        'Take corrective action and feed back into the next plan',
      ] } },
      explanation: 'This is the planning–control loop. The "feed back" step is what makes management accounting iterative rather than one-off.',
      sectionLink: '20.1.1',
    },
    {
      id: 'r20-11', chapterId: 20, sectionId: '20.1', type: 'fill-chip',
      prompt: 'Complete the sentence about the control role.',
      itemData: { type: 'fill-chip', data: { sentence: 'In the control role, actual results are compared with the budget and any differences are called ___.', chips: ['Variances', 'Drawings', 'Adjustments', 'Accruals'], correctChip: 'Variances' } },
      explanation: 'Variances can be favourable (better than budget) or adverse (worse than budget). They focus management attention on areas needing action.',
      sectionLink: '20.1.1',
    },
    {
      id: 'r20-12', chapterId: 20, sectionId: '20.1', type: 'match',
      prompt: 'Match each typical management-accounting decision with the question it answers.',
      itemData: { type: 'match', data: { pairs: [
        { term: 'Make-or-buy', definition: 'Should we produce internally or buy from a supplier?' },
        { term: 'Special order', definition: 'Should we accept a one-off order below normal price?' },
        { term: 'Pricing', definition: 'What price should we charge to cover costs and earn profit?' },
        { term: 'Discontinue', definition: 'Should we stop producing a loss-making product?' },
      ] } },
      explanation: 'These short-term decisions all rely on relevant cost analysis — comparing the costs that change between alternatives.',
      sectionLink: '20.1.1',
    },
  ],
  ...
  21: [
    {
      ...
      prompt: 'Sort each cost into Fixed, Variable or Semi-variable.',
      itemData: { type: 'sort', data: { buckets: ['Fixed', 'Variable', 'Semi-variable'], items: [
        { label: 'Factory rent', correctBucket: 'Fixed' },
        { label: 'Raw materials', correctBucket: 'Variable' },
        { label: 'Telephone (line rental + call charges)', correctBucket: 'Semi-variable' },
        { label: 'Direct labour (piece rate)', correctBucket: 'Variable' },
        { label: 'Straight-line depreciation', correctBucket: 'Fixed' },
        { label: 'Electricity (standing charge + units used)', correctBucket: 'Semi-variable' },
      ] } },
      explanation: 'Fixed costs stay constant in total. Variable costs change in proportion to output. Semi-variable costs have both a fixed and a variable element.',
      sectionLink: '21.1.1',
    },
    {
      id: 'r21-02', chapterId: 21, sectionId: '21.1', type: 'sort',
      prompt: 'Sort each cost: Direct (traceable to a product) or Indirect (overhead)?',
      itemData: { type: 'sort', data: { buckets: ['Direct', 'Indirect'], items: [
        { label: 'Wood used to make a chair', correctBucket: 'Direct' },
        { label: 'Wages of the chair-maker (paid per chair)', correctBucket: 'Direct' },
        { label: 'Factory supervisor salary', correctBucket: 'Indirect' },
        { label: 'Factory rent', correctBucket: 'Indirect' },
        { label: 'Royalty payable per chair sold', correctBucket: 'Direct' },
        { label: 'Depreciation of factory equipment', correctBucket: 'Indirect' },
      ] } },
      explanation: 'Direct costs are traceable to one cost unit (one chair). Indirect costs (overheads) cannot be traced and must be apportioned across all units.',
      sectionLink: '21.1.2',
    },
    {
      id: 'r21-03', chapterId: 21, sectionId: '21.1', type: 'fill-chip',
      prompt: 'Complete the formula.',
      itemData: { type: 'fill-chip', data: { sentence: 'Prime Cost = Direct Materials + Direct Labour + ___.', chips: ['Direct Expenses', 'Factory Overheads', 'Selling Expenses', 'Administration Costs'], correctChip: 'Direct Expenses' } },
      explanation: 'Prime cost is the sum of all DIRECT costs of production. Adding factory (production) overheads gives the total production cost.',
      sectionLink: '21.1.2',
    },
    {
      id: 'r21-04', chapterId: 21, sectionId: '21.1', type: 'match',
      prompt: 'Match each cost behaviour with how it changes per unit as output rises.',
      itemData: { type: 'match', data: { pairs: [
        { term: 'Fixed cost', definition: 'Decreases per unit as output rises' },
        { term: 'Variable cost', definition: 'Stays the same per unit' },
        { term: 'Semi-variable cost', definition: 'Decreases per unit but never reaches zero' },
        { term: 'Step fixed cost', definition: 'Constant within a range, then jumps' },
      ] } },
      explanation: 'Watch the trap: total fixed cost stays constant, but per-unit fixed cost falls as output rises (the same €100 spread over more units).',
      sectionLink: '21.1.1',
    },
    {
      id: 'r21-05', chapterId: 21, sectionId: '21.1', type: 'true-false',
      prompt: 'True or false?',
      itemData: { type: 'true-false', data: { statement: 'Total variable costs stay the same regardless of output.', isTrue: false, followUp: { prompt: 'How do total variable costs behave?', chips: ['Rise in proportion to output', 'Fall as output rises', 'Stay constant per unit AND in total'], correctChip: 'Rise in proportion to output' } } },
      explanation: 'Total variable cost rises with output (more units = more material). Variable cost PER UNIT stays the same. Confusing the two costs marks in Q9.',
      sectionLink: '21.1.1',
    },
    {
      id: 'r21-06', chapterId: 21, sectionId: '21.2', type: 'mcq',
      prompt: 'High-low method. High activity: 800 units, total cost €6,200. Low activity: 300 units, total cost €3,700. Variable cost per unit?',
      itemData: { type: 'mcq', data: { options: ['€5.00', '€7.75', '€12.33', '€2.50'], correctIndex: 0 } },
      explanation: 'VC per unit = (€6,200 − €3,700) / (800 − 300) = €2,500 / 500 = €5.00.',
      sectionLink: '21.2.1',
    },
    {
      id: 'r21-07', chapterId: 21, sectionId: '21.2', type: 'mcq',
      prompt: 'Using the figures above, what is the total fixed cost element?',
      itemData: { type: 'mcq', data: { options: ['€2,200', '€3,700', '€6,200', '€2,500'], correctIndex: 0 } },
      explanation: 'Fixed cost = Total cost − (VC × units). At 800 units: €6,200 − (€5 × 800) = €6,200 − €4,000 = €2,200. Cost equation: TC = €2,200 + €5x.',
      sectionLink: '21.2.1',
    },
    {
      id: 'r21-08', chapterId: 21, sectionId: '21.1', type: 'define',
      prompt: 'Define the following term.',
      itemData: { type: 'define', data: { term: 'Semi-variable cost', modelDefinition: 'A cost that has both a fixed element and a variable element — e.g. an electricity bill with a standing charge plus a per-unit charge.' } },
      explanation: 'Semi-variable costs must be split into their fixed and variable parts using the high-low method before they can be used in CVP analysis.',
      sectionLink: '21.1.1',
    },
    {
      id: 'r21-09', chapterId: 21, sectionId: '21.1', type: 'order',
      prompt: 'Order these costs from MOST product-related to LEAST product-related.',
      itemData: { type: 'order', data: { steps: [
        'Direct materials (used in the product itself)',
        'Direct labour (workers making the product)',
        'Factory overheads (rent, supervision)',
        'Administration overheads (office costs)',
        'Selling and distribution overheads (sales reps, delivery)',
      ] } },
      explanation: 'Production-related costs (material, labour, factory overhead) form the cost of the product. Administration and selling are period costs charged to the P&L when incurred.',
      sectionLink: '21.1.2',
    },
    {
      id: 'r21-10', chapterId: 21, sectionId: '21.1', type: 'true-false',
      prompt: 'True or false?',
      itemData: { type: 'true-false', data: { statement: 'A cost can be both indirect to one cost unit and direct to another.', isTrue: true } },
      explanation: 'A factory supervisor’s salary is indirect to a single chair but direct to the factory as a cost centre. Classification depends on what is being costed.',
      sectionLink: '21.1.2',
    },
    {
      id: 'r21-11', chapterId: 21, sectionId: '21.1', type: 'fill-chip',
      prompt: 'Complete the statement.',
      itemData: { type: 'fill-chip', data: { sentence: 'Costs that managers can influence within the short term are called ___ costs.', chips: ['Controllable', 'Sunk', 'Fixed', 'Notional'], correctChip: 'Controllable' } },
      explanation: 'Controllable costs are within a manager’s authority and form the basis of responsibility accounting. Uncontrollable costs (e.g. head office rent) should not be used to judge the local manager.',
      sectionLink: '21.1.2',
    },
    {
      id: 'r21-12', chapterId: 21, sectionId: '21.1', type: 'mcq',
      prompt: 'Which of these is the BEST example of a step fixed cost?',
      itemData: { type: 'mcq', data: { options: ['Raw materials', 'Salary of one supervisor per 50 workers', 'Sales commission', 'Telephone bill'], correctIndex: 1 } },
      explanation: 'A new supervisor must be hired every 50 workers — total cost is fixed within each band but jumps at the threshold. Materials are variable; supervisor pay between bands does not change.',
      sectionLink: '21.1.1',
    },
  ],
  ...
  22: [
    ...
    {
      id: 'r22-09', chapterId: 22, sectionId: '22.2', type: 'mcq',
      prompt: 'Machining Dept: budgeted overheads €120,000, budgeted machine hours 8,000, budgeted labour hours 2,000. What is the Machine-Hour OAR?',
      itemData: { type: 'mcq', data: { options: ['€15 per machine hour', '€60 per machine hour', '€8 per machine hour', '€0.067 per machine hour'], correctIndex: 0 } },
      explanation: 'Machine-Hour OAR = €120,000 / 8,000 = €15 per machine hour. Use machine hours because Machining is machine-intensive.',
      sectionLink: '22.2.2',
    },
    {
      id: 'r22-10', chapterId: 22, sectionId: '22.2', type: 'mcq',
      prompt: 'Continuing the example: actual machine hours 8,500, actual overheads €131,000. What is the under-/over-absorption?',
      itemData: { type: 'mcq', data: { options: ['Under-absorbed €3,500', 'Over-absorbed €3,500', 'Under-absorbed €11,000', 'Exactly absorbed'], correctIndex: 0 } },
      explanation: 'Absorbed = 8,500 × €15 = €127,500. Actual = €131,000. Actual > absorbed → under-absorbed €3,500 (debited to P&L).',
      sectionLink: '22.2.2',
    },
    {
      id: 'r22-11', chapterId: 22, sectionId: '22.2', type: 'match',
      prompt: 'Match each department to the most appropriate basis of overhead absorption.',
      itemData: { type: 'match', data: { pairs: [
        { term: 'Highly automated Machining department', definition: 'Machine-Hour Rate' },
        { term: 'Hand-Assembly department', definition: 'Labour-Hour Rate' },
        { term: 'Finishing — predominantly manual', definition: 'Labour-Hour Rate' },
        { term: 'Department running CNC machines 24/7', definition: 'Machine-Hour Rate' },
      ] } },
      explanation: 'Choose the basis that drives the overhead. Machine-intensive → machine hours. Labour-intensive → labour hours.',
      sectionLink: '22.2.2',
    },
  ],
